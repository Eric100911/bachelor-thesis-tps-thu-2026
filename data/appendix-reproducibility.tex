...
This appendix provides a centralized record of the input-version information on which the figures, tables, and results in the thesis depend, including the data-taking period, trigger version, ntuple or skim version, MC configuration summary, and the corresponding tags in external analysis workspaces.
...
Because the figures used in the thesis are typically produced in other workspaces, this repository does not require the plotting scripts to be stored.
However, every figure included in the thesis should have at least the following information recorded in \texttt{notes/provenance.md}:
...
Before finalizing the thesis, the following information should be checked item by item to confirm that it has been completed:
